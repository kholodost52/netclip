...
export default function SlideSection({
  ...
  const settings = {
    ...
    arrows:false,
    customPaging: () => (
      <div className="w-3 h-3 bg-red-700 rounded-full mt-20"></div>
    ),
    ...
    <ul className="mb-10">
      <Slider {...settings} className="mb-10">
        {SliderCards.map((slide) => (
          <li key={slide.id} className="w-70 h-85">
            <div className=" h-full bg-[#dfdfdf] mt-5.25 ml-4 mr-6 pt-5.75 pl-4 pr-12 ">
              {/* <div className=""> */}
